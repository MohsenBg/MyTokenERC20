...
const Approve: React.FunctionComponent<Props> = ({ params }) => {
        ...
        if (parseFloat(Balance) >= parseFloat(balanceTransfer)) {
          try {
            await ContractLoopToken.methods
              .approve(addressTo, balanceTransfer)
  ...
  return (
    <div className={styles.container}>
      <div className={styles.content}>
        <h1 className={styles.title}> Approve </h1>
              ...
              <div className={styles.address}>
                ...
                {optionsOpen ? (
                  <div className={styles.options}>
                    <div className={styles.option} onClick={handelOption}>
                      Product
                    </div>
                  </div>
                ) : null}
